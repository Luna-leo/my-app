...
function PlotlyChartWithDataOptimizedComponent({
  config,
...
export const PlotlyChartWithDataOptimized = memo(PlotlyChartWithDataOptimizedComponent, (prevProps, nextProps) => {
